                ...
                <div class="container-custom">
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <form>
                                <label for="formGroupExampleInput" className="text1" >Name</label>
                                <div class="form-outline mb-4">
                                    <input type="text" id="form2Example11" class="form-control"
                                        placeholder="" className="lable" />

                                </div>
                                <label for="formGroupExampleInput2" className="text1">Email</label>
                                <div class="form-outline mb-2">
                                    <input type="email" id="form2Example22" class="form-control" placeholder="" className="lable" />
                                </div>
                                <label for="formGroupExampleInput2" className="text1">UserName</label>
                                <div class="form-outline mb-2">
                                    <input type="text" id="form2Example22" class="form-control" placeholder="" className="lable" />
                                </div>
                                ...
                                <label for="formGroupExampleInput2" className="text1">Confirm Password</label>
                                <div class="form-outline mb-2">
                                    <input type="password" id="form2Example22" class="form-control" placeholder="" className="lable" />
                                </div>
                            </form>
